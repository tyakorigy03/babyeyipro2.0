  ...
  return (
    <div className="flex flex-col h-full bg-white border border-slate-200 overflow-hidden text-sm text-slate-700">
      ...
      <div className="flex items-center justify-between px-5 py-2 border-b border-slate-200 bg-white">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 relative">
            ...
            <Settings 
              className={`w-4 h-4 cursor-pointer transition-colors ${showSettings ? 'text-accent' : 'text-slate-400 hover:text-slate-600'}`} 
        ...
        <div className="flex items-center gap-5">
          {/* Search */}
          <div className="flex items-center border border-slate-300 rounded-md overflow-hidden focus-within:border-accent">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-56 border-r border-primary/2 p-3 bg-white overflow-y-auto">
          ...
          <nav className="space-y-0.5">
            <div className="mb-1">
              <button 
                className="w-full flex items-center justify-between px-2 py-1 rounded cursor-pointer text-xs transition-all bg-accent/5 text-accent font-semibold"
              >
                <span>All Classes</span>
                <span className="text-[10px] font-medium text-accent">890</span>
              </button>
            </div>
          ...
          <table className="w-full text-left border-collapse table-fixed">
            <thead>
              <tr className="border-b border-slate-200 text-slate-800 text-[11px] font-bold bg-white sticky top-0 z-10">
                <th className="px-4 py-2 w-10 border-r border-primary/2"><input type="checkbox" className="rounded border-slate-300 text-primary focus:ring-primary/20" /></th>
                <th className="px-4 py-2 border-r border-primary/2 uppercase tracking-wider">Name</th>
                <th className="px-4 py-2 border-r border-primary/2 uppercase tracking-wider">Gender</th>
                <th className="px-4 py-2 border-r border-primary/2 uppercase tracking-wider">Class</th>
                <th className="px-4 py-2 uppercase tracking-wider">Parent/Guardian</th>
              </tr>
            </thead>
            <tbody className="text-[11px]">
              {studentsData.map((stu, index) => (
                <tr key={stu.id} className={`border-b border-primary/2 cursor-pointer transition-colors hover:bg-primary/5 ${index % 2 !== 0 ? 'bg-primary/2' : 'bg-white'}`}>
                  ...
                  <td className="px-4 py-1.5">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded bg-primary/10 flex items-center justify-center text-[10px] font-bold text-primary overflow-hidden shadow-sm border border-primary/2">
                        {stu.name.charAt(0)}
                      </div>
                  ...
                  <td className="px-4 py-1.5 text-slate-600 font-medium border-r border-primary/2">{stu.class}</td>
