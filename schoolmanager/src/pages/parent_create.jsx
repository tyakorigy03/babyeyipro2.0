          ...
          <div className="space-y-8 animate-in fade-in duration-500">
             <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                ...
                <button 
                  ...
                  className="bg-primary text-white px-4 py-1.5 rounded text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:scale-105 transition-all"
                >
             ...
             {assignedStudents.length === 0 ? (
               <div 
                 onClick={() => setIsAssignModalOpen(true)}
                 className="py-20 bg-transparent  rounded flex flex-col items-center justify-center text-center space-y-6 cursor-pointer group hover:bg-slate-50/50 hover:border-primary/20 transition-all"
               >
                  <div className="relative">
                    <Users size={64} strokeWidth={1} className="text-slate-100 group-hover:text-primary transition-all" />
                    <div className="absolute -top-1 -right-1 w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center border-2 border-white scale-0 group-hover:scale-100 transition-transform shadow-lg">
                       <Plus size={16} />
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                     <span className="text-[10px] font-black text-primary uppercase tracking-widest border-b-2 border-primary/10 pb-1 group-hover:border-primary transition-all">
                       Link Students +
                     </span>
                  </div>
               </div>
                  ...
                  {assignedStudents.map(student => (
                    ...
                    >
                       <div className="flex items-center gap-6 flex-1">
                          <div className="w-16 h-16 rounded-2xl bg-slate-50 flex items-center justify-center text-xl font-black text-primary border border-slate-100 group-hover:scale-105 transition-transform shadow-sm">
                       ...
                       <div className="flex items-center gap-12">
                          <div className="flex flex-col items-end gap-1">
                             ...
                             <div className="relative">
                                <select 
                                  className="bg-transparent text-sm font-black text-primary border-none focus:ring-0 appearance-none cursor-pointer text-right pr-6"
                                ...
                                <ChevronRight size={14} className="absolute right-0 top-1/2 -translate-y-1/2 text-primary pointer-events-none rotate-90" />
                             </div>
                          </div>
                          <button 
             ...
             <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-3 items-center">
                  ...
                  <input type="text" placeholder="1 1990 8 0000000 0 00" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
                <div className="grid grid-cols-3 items-center">
                  <label className="text-sm font-semibold text-slate-700">Passport No.</label>
                  <input type="text" placeholder="Optional" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-3 items-center">
                  ...
                  <input type="text" placeholder="Account Number" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary font-mono" />
                </div>
                <div className="grid grid-cols-3 items-center">
                  <label className="text-sm font-semibold text-slate-700">Billing Address</label>
                  <input type="text" placeholder="Kigali, Rwanda" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="flex flex-col h-full bg-white border border-slate-200 overflow-hidden font-sans">
      ...
      <div className="flex items-center justify-between px-6 py-2 bg-white border-b border-slate-200 sticky top-0 z-20">
        <div className="flex items-center gap-4">
          <Link to="/students/parents" className="text-slate-400 hover:text-primary transition-colors">
            <ArrowLeft size={20} />
          </Link>
                          ...
                          {filteredStudents.map((item, idx) => (
                            <tr key={idx} className={`border-b border-slate-200 cursor-pointer transition-colors hover:bg-primary/5 ${idx % 2 !== 0 ? 'bg-slate-50' : 'bg-white'}`}>
                              ...
                              <td className="px-6 py-2.5 text-right">
                                <button onClick={() => { setSelectedStudentForAssign(item); setModalStep('Relation'); }} className="bg-white hover:bg-primary hover:text-white text-primary px-3 py-1 rounded border border-primary/20 text-[10px] font-bold uppercase transition-all shadow-sm">
                                  Select
                                </button>
                              </td>
                            </tr>
                       ...
                       <div className="space-y-4 pt-4">
                          <div className="grid grid-cols-3 items-center">
                             ...
                             <div className="col-span-2 relative">
                                <select 
                                  className="w-full text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary appearance-none cursor-pointer font-medium text-slate-700"
                ...
                <div>
                   {modalStep === 'Relation' ? (
                     ...
                     <button 
                        ...
                        className="text-primary hover:text-primary/80 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all px-4 py-2 rounded-lg hover:bg-slate-50"
                      >
                ...
                <div className="flex items-center gap-4">
                   ...
                   {modalStep === 'Relation' && (
                     <button 
                        ...
                        className="bg-primary text-white px-6 py-2 rounded font-bold text-[10px] uppercase tracking-widest shadow-md shadow-primary/20 hover:opacity-90 transition-all flex items-center gap-2"
                      >
