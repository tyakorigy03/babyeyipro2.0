...
export default function SuperAdminHome() {
  const apps = [
    { width: 12, iconUrl: '/icons/dashboards.png',    label: 'Dashboard',    path: '/superadmin/dashboard' },
    { width: 12, iconUrl: '/icons/students.png',      label: 'Schools',      path: '/superadmin/schools' },
    { width: 12, iconUrl: '/icons/staff.png',         label: 'Agents',       path: '/superadmin/agents' },
    { width: 12, iconUrl: '/icons/fees.png',          label: 'Stations',     path: '/superadmin/stations' },
    { width: 12, iconUrl: '/icons/shuleavance.png',   label: 'Partners',     path: '/superadmin/partners' },
    { width: 12, iconUrl: '/icons/icard.png',         label: 'TichaDeals',   path: '/superadmin/ticha-deals' },
    { width: 12, iconUrl: '/icons/assessment.png',    label: 'ShuleKits',    path: '/superadmin/shule-kits' },
    { width: 12, iconUrl: '/icons/payroll.png',       label: 'Finance',      path: '/superadmin/finance' },
    { width: 12, iconUrl: '/icons/attendance.png',    label: 'Analytics',    path: '/superadmin/analytics' },
    { width: 12, iconUrl: '/icons/displine.png',      label: 'Audit Logs',   path: '/superadmin/audit-logs' },
    { width: 12, iconUrl: '/icons/timetable.png',     label: 'Settings',     path: '/superadmin/settings' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-primary/40 text-[10px] uppercase tracking-[0.2em] font-bold">Platform by</span>
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-primary/60 text-[11px] font-medium tracking-wide uppercase">
              SuperAdmin Control Panel · BabyeyiPro 2.0
            </p>
