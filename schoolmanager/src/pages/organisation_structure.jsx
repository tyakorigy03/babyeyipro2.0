        ...
        {source === 'select' ? (
          <div className="space-y-4">
            <div className="relative">
              ...
              <input type="text" placeholder="Search staff by name or ID..." className="w-full pl-7 py-2 text-sm bg-transparent border-b border-slate-200 focus:outline-none focus:border-primary transition-colors" />
            </div>
