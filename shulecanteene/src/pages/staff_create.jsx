            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 items-center">
                  ...
                  <input type="text" placeholder="e.g. Mathematics Teacher" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
                <div className="grid grid-cols-3 items-center">
                  <label className="text-sm font-semibold text-slate-700">Job Title</label>
                  <input type="text" placeholder="e.g. Senior Teacher" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
                <div className="grid grid-cols-3 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 items-center">
                  ...
                  <input type="text" placeholder="Account Number" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 items-center">
                  ...
                  <input type="text" placeholder="ID / Passport Number" className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 items-center">
                      ...
                      <div className="col-span-2 flex items-center gap-2">
                        <input type="number" placeholder="0" className="flex-1 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary font-bold" />
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={allowance.label} className="grid grid-cols-3 items-center">
                        ...
                        <div className="col-span-2 flex items-center gap-2">
                          <input type="number" placeholder={allowance.placeholder} className="flex-1 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 items-center">
                      ...
                      <input type="text" placeholder="e.g. 00045-0697..." className="col-span-2 text-sm bg-transparent border-b border-slate-200 py-1.5 focus:outline-none focus:border-primary" />
                    </div>
                  </div>
                </div>
              </div>
